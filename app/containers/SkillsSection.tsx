...
const Tooltip = ({
    ...
    <div
        className={cn(
            "absolute -top-10 left-1/2 -translate-x-1/2 px-2 py-1 rounded-md bg-gray-800 text-white text-sm transition-opacity duration-200 whitespace-nowrap overflow-hidden",
...
>(({ className, children, altText }, ref) => {
    ...
    return (
        <div
            ref={ref}
            className={cn(
                "relative z-10 size-12 items-start justify-center rounded-full bg-[#191b2a] p-1.5 shadow-[0_0_12px_-12px_rgba(0,0,0,0.8)]",
                className
            )}
        ...
        >
            {children}
            <Tooltip text={altText} visible={showTooltip} />
        </div>
    );
});
...
export default function SkillSection() {
    ...
    return (
        <div
            className="relative flex w-full items-start h-auto justify-center overflow-hidden md:shadow-xl bg-black"
            ref={containerRef}
        >
...
// import { AnimatedBeam } from "@/app/components/magicui/AnimatedBeam";
// import { cn } from "@/app/lib/utils";
// import { express, figma, firebase, github, java, nextjs, nodejs, react, tailwind, typescript, user, vscode } from "@/public/Svg/import";
// import Image from "next/image";
// import React, { forwardRef, useRef } from "react";

// const Circle = forwardRef<HTMLDivElement, { className?: string; children?: React.ReactNode }>(({ className, children }, ref) => {
//     return (
//         <div ref={ref} className={cn("z-10 size-12 items-start justify-center rounded-full bg-[#191b2a] p-3 shadow-[0_0_12px_-12px_rgba(0,0,0,0.8)]", className)}>
//             {children}
//         </div>
//     );
// });
...
//     return (
//         <div className="relative flex h-[500px] w-full items-start justify-center overflow-hidden md:shadow-xl bg-black" ref={containerRef}>
//             <div className="flex size-full flex-col max-w-lg max-h-[200px] items-stretch justify-between gap-10">
//                 <div className="flex flex-row items-center justify-evenly">
//                     <Circle ref={div1Ref}><Image src={firebase} alt="Firebase" /></Circle>
//                     <Circle ref={div5Ref}><Image src={figma} alt="Figma" /></Circle>
//                 </div>
//                 <div className="flex flex-row items-center justify-around">
//                     <Circle ref={div2Ref}><Image src={nodejs} alt="Node.js" /></Circle>
//                     <Circle ref={div4Ref} className="size-16"><Image src={user} alt="User" /></Circle>
//                     <Circle ref={div6Ref}><Image src={express} alt="Express" /></Circle>
//                 </div>
//                 <div className="flex flex-row items-center justify-between">
//                     <Circle ref={div3Ref}><Image src={tailwind} alt="Tailwind" /></Circle>
//                     <Circle ref={div7Ref}><Image src={vscode} alt="VS Code" /></Circle>
//                 </div>
//                 <div className="flex flex-row items-center justify-between">
//                     <Circle ref={div8Ref}><Image src={nextjs} alt="Next.js" /></Circle>
//                     <Circle ref={div9Ref}><Image src={react} alt="React" /></Circle>
//                 </div>
//                 <div className="flex flex-row items-center justify-evenly">
//                     <Circle ref={div10Ref}><Image src={java} alt="Java" /></Circle>
//                     <Circle ref={div12Ref}><Image src={github} alt="GitHub" /></Circle>
//                     <Circle ref={div11Ref}><Image src={typescript} alt="TypeScript" /></Circle>
//                 </div>
//             </div>
...
//             <AnimatedBeam containerRef={containerRef} fromRef={div9Ref} toRef={div4Ref} curvature={75} endYOffset={10} reverse />
//             <AnimatedBeam containerRef={containerRef} fromRef={div10Ref} toRef={div4Ref} curvature={75} endYOffset={10} />
//             <AnimatedBeam containerRef={containerRef} fromRef={div11Ref} toRef={div4Ref} curvature={75} endYOffset={10} reverse />
//             <AnimatedBeam containerRef={containerRef} fromRef={div12Ref} toRef={div4Ref} curvature={75} endYOffset={10} reverse duration={10} />
//         </div>
...
//!v1
// 'use client';
// import { FollowerPointerCard } from "@/app/components/acternityui/FollowPointer"; // Import the modified FollowerPointerCard
// import { AnimatedBeam } from "@/app/components/magicui/AnimatedBeam";
// import { cn } from "@/app/lib/utils";
// import { express, figma, firebase, github, java, nextjs, nodejs, react, tailwind, typescript, user, vscode } from "@/public/Svg/import";
// import Image from "next/image";
...
// const Circle = forwardRef<HTMLDivElement, { className?: string; children?: React.ReactNode }>(({ className, children }, ref) => {
//     return (
//         <div ref={ref} className={cn("z-10 size-12 items-start justify-center rounded-full bg-[#0e1831] p-3 shadow-[0_0_12px_-12px_rgba(0,0,0,0.8)]", className)}>
//             {children}
//         </div>
//     );
// });
...
//     return (
//         <div
//             className="relative flex h-[500px] w-full items-center justify-center overflow-hidden rounded-lg  bg-background p-10 md:shadow-xl bg-black"
//             ref={containerRef}
//         >
//             <div className="flex size-full flex-col max-w-lg max-h-[200px] items-stretch justify-between gap-10">
//                 <div className="flex flex-row items-center justify-between">
//                     <Circle ref={div1Ref}>
//                         <Image src={figma} alt="Google Drive" className="w-8 h-8" />
//                     </Circle>
//                     <Circle ref={div5Ref}>
//                         <Image src={javascript} alt="Google Docs" className="w-8 h-8" />
//                     </Circle>
//                 </div>
//                 <div className="flex flex-row items-center justify-between">
//                     <Circle ref={div2Ref}>
//                         <Image src={express} alt="express" className="w-8 h-8" />
//                     </Circle>
//                     <Circle ref={div4Ref} className="size-16">
//                         <Image src={user} alt="user" className="w-8 h-8" />
//                     </Circle>
//                     <Circle ref={div6Ref}>
//                         <Image src={vscode} alt="vscode" className="w-8 h-8" />
//                     </Circle>
//                 </div>
//                 <div className="flex flex-row items-center justify-between">
//                     <Circle ref={div3Ref}>
...
//         <div
//             className={cn(
//                 "relative flex h-[500px] w-full items-center justify-center overflow-hidden rounded-lg p-10 md:shadow-xl bg-black",
//                 className,
//             )}
//             ref={containerRef}
//         >
...
//         <div id='skillSection' className='flex overflow-hidden  px-7 pb-8 justify-around items-center gap-x-0 gap-y-0 z-50 bg-black'>

//             <div id='skillContainer' className='overflow-hidden w-[80vw]  bg-[linear-gradient(144deg,#6248ff,rgba(4,21,24,0.7)_43%,rgba(169,46,196,0.7))]  mx-auto py-2.5 px-2.5  rounded-[30px] '>
