                        ...
                        {items.map((item, idx) => (
                            ...
                            >
                                <Link
                                    href={item.href}
                                    key={item.title}
                                    className="h-12 w-12 rounded-full bg-gray-50 dark:bg-neutral-400 flex items-center justify-center"
                                >
                                    <div className="h-10 w-10 flex items-center justify-center">{item.icon}</div>
                                </Link>
                            </motion.div>
                        ))}
                    </motion.div>
...
//                                     href={item.href}
//                                     key={item.title}
//                                     className="h-10 w-10 rounded-full bg-gray-50 dark:bg-neutral-400 flex items-center justify-center"
//                                 >
